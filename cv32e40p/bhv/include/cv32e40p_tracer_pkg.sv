...
//Zba
  parameter INSTR_SH1ADD = {7'b0010000, 10'b?, 3'b010, 5'b?, OPCODE_OP};
  parameter INSTR_SH2ADD = {7'b0010000, 10'b?, 3'b100, 5'b?, OPCODE_OP};
  parameter INSTR_SH3ADD = {7'b0010000, 10'b?, 3'b110, 5'b?, OPCODE_OP};
  ...
  parameter INSTR_BCLR = {7'b0100100, 10'b?, 3'b001, 5'b?, OPCODE_OP};
  parameter INSTR_BEXT = {7'b0100100, 10'b?, 3'b101, 5'b?, OPCODE_OP};
  parameter INSTR_BINV = {7'b0110100, 10'b?, 3'b001, 5'b?, OPCODE_OP};
  parameter INSTR_BSET = {7'b0010100, 10'b?, 3'b001, 5'b?, OPCODE_OP};

  //Zbs (register-immediate)
  parameter INSTR_BCLRI = {7'b0100100, 10'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_BEXTI = {7'b0100100, 10'b?, 3'b101, 5'b?, OPCODE_OPIMM};
  parameter INSTR_BINVI = {7'b0110100, 10'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_BSETI = {7'b0010100, 10'b?, 3'b001, 5'b?, OPCODE_OPIMM};

  //Zbc
  parameter INSTR_CLMUL = {7'b0000101, 10'b?, 3'b001, 5'b?, OPCODE_OP};
  parameter INSTR_CLMULH = {7'b0000101, 10'b?, 3'b011, 5'b?, OPCODE_OP};
  parameter INSTR_CLMULR = {7'b0000101, 10'b?, 3'b010, 5'b?, OPCODE_OP};

  //Zbb (register-register)
  parameter INSTR_ZBB_ANDN  = {7'b0100000, 10'b?, 3'b111, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_ORN   = {7'b0100000, 10'b?, 3'b110, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_XNOR  = {7'b0100000, 10'b?, 3'b100, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_MIN   = {7'b0000101, 10'b?, 3'b100, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_MINU  = {7'b0000101, 10'b?, 3'b101, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_MAX   = {7'b0000101, 10'b?, 3'b110, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_MAXU  = {7'b0000101, 10'b?, 3'b111, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_ROL   = {7'b0110000, 10'b?, 3'b001, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_ROR   = {7'b0110000, 10'b?, 3'b101, 5'b?, OPCODE_OP};
  parameter INSTR_ZBB_ZEXTH = {7'b0000100, 5'b00000, 5'b?, 3'b100, 5'b?, OPCODE_OP};

  //Zbb (register-immediate)
  parameter INSTR_ZBB_CLZ   = {7'b0110000, 5'b00000, 5'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZBB_CTZ   = {7'b0110000, 5'b00001, 5'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZBB_CPOP  = {7'b0110000, 5'b00010, 5'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZBB_SEXTB = {7'b0110000, 5'b00100, 5'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZBB_SEXTH = {7'b0110000, 5'b00101, 5'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZBB_RORI  = {7'b0110000, 10'b?,     3'b101, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZBB_ORCB  = {7'b0010100, 5'b00111, 5'b?, 3'b101, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZBB_REV8  = {7'b0110100, 5'b11000, 5'b?, 3'b101, 5'b?, OPCODE_OPIMM};

  //Zbkb (register-register)
  parameter INSTR_PACK  = {7'b0000100, 10'b?, 3'b100, 5'b?, OPCODE_OP};
  parameter INSTR_PACKH = {7'b0000100, 10'b?, 3'b111, 5'b?, OPCODE_OP};
 
  //Zbkb 
  parameter INSTR_BREV8 = {12'h687, 5'b?, 3'b101, 5'b?, OPCODE_OPIMM};
  parameter INSTR_ZIP   = {12'h08F, 5'b?, 3'b001, 5'b?, OPCODE_OPIMM};
  parameter INSTR_UNZIP = {12'h08F, 5'b?, 3'b101, 5'b?, OPCODE_OPIMM};
 
  //Zbkx (register-register)
  parameter INSTR_XPERM4 = {7'b0010100, 10'b?, 3'b010, 5'b?, OPCODE_OP};
  parameter INSTR_XPERM8 = {7'b0010100, 10'b?, 3'b100, 5'b?, OPCODE_OP};
