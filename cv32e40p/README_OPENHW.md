> This file is the original documentation of the OpenHW Group repository.
> For the documentation of the internship work (implementation of the
> Zb bit-manipulation extension), see [`README.md`](README.md).
